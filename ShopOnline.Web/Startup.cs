...
using ShopOnline.Web.Extension;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCors(options =>
            {
                ...
                {
                    builder.WithOrigins("http://localhost:57845")
                        .AllowCredentials();
                });
            });
            ...
            services.AddTransient<IValidator<CreatProduct>, CreatProductValidator>();
            services.AddTransient<ILanguageConnectAPI, LanguageConnectAPI>();
            services.AddTransient<IImageUserConnectAPI, ImageUserConnectAPI>();
            services.AddTransient<IPageConnectAPI, PageConnectAPI>();
            services.AddTransient<IAnnoucementConnectAPI, AnnoucementConnectAPI>();
            ...
            services.AddControllersWithViews().AddFluentValidation(fv => fv.RegisterValidatorsFromAssemblyContaining<CreatProductValidator>());
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                endpoints.MapHub<HubUser>("/hubUser");
                endpoints.MapHub<ChatHub>("/chatHub");
                endpoints.MapControllerRoute(
                      name: "MyArea",
                      pattern: "{culture=vi}/{area:exists}/{controller=Home}/{action=Index}/{id?}");
                endpoints.MapControllerRoute(
                      name: "MyArea",
