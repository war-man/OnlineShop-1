...
namespace ShopOnline.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        [HttpPost("GetAllProductPagingPart2")]
        public async Task<IActionResult> GetAllProductPagingPart2([FromBody]RequestBase request)
        {
            var find = await _productSerVice.GetAllProductPagingPart2(request);
            return Ok(find);
        }
    }
}
